...
public class CompanyPost extends AVObject {
    ...
    public CompanyPost(String title, String content, Date datePlanned, String destination, AVUser user) {
        put(TITLE, title);
        put(CONTENT, content);
    ...
    public static List<CompanyPost> findCompanyPost(int skip, int limit, String dateString, String cityName) throws AVException {
