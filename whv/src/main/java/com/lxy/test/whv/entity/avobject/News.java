...
public class News extends AVObject {
    ...
    public News(String title, String content, String imgUrl, String url, AVUser user) {
        put(TITLE, title);
        put(CONTENT, content);
        put(USER, user);
        put(IMGURL, imgUrl);
    ...
    public static List<News> getPost(int skip, int limit) throws AVException {

        AVQuery<News> q = News.getQuery(News.class);
        //hehe 还好哟示例
