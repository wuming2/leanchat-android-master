package com.lxy.test.whv.service.event;
...
import com.lxy.test.whv.util.NetAsyncTask;
...
public class UpdateService {
    ...
    //TODO test
    public static void createUpdateInfo() {
        try {
            UpdateInfo updateInfo = new UpdateInfo();
            updateInfo.setVersion(1);
            updateInfo.setApkUrl("");
            updateInfo.setDesc("基础版本");
            updateInfo.saveInBackground();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
