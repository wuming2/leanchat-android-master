 ...
 */
public class CompanyAdapter extends BaseListAdapter<LeanchatUser> {
    ...
    public CompanyAdapter(Context ctx) {
        super(ctx);
        init();
    }

    public CompanyAdapter(Context ctx, List<LeanchatUser> datas) {
        super(ctx, datas);
        init();
    }
